...
@Component({
  ...
  templateUrl: './calendrier-bassin.component.html',
  styleUrls: ['./calendrier-bassin.component.css']
})
export class CalendrierBassinComponent implements OnInit {
  id:number;
  ...
  onSubmit() {
    this.activiteService.getActivitesOfBassin(this.id).subscribe(
      data => {
        this.activites = data,
